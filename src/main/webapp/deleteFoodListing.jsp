...
int deleted = FoodListingDAO.deleteFoodListing(foodId);
if (deleted > 0) {
    response.sendRedirect("donorDashboard.jsp?success=listing_deleted");
} else {
    response.sendRedirect("donorDashboard.jsp?error=delete_failed");
}
%>